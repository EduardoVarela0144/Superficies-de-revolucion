...
x = [0:0.1:3];                           %vector con valores para variable y r(x)
%función f(x,y)=0
z1 = real(9-x.^2);                             %función de radio r(y) = x
...
axis equal
grid on
title('Ecuación de superficie : y^2 + z^2 = (9-x^2) con eje de revolución en x cuando x>=0');
